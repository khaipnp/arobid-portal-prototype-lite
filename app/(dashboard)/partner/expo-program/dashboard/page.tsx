...
export default async function PartnerExpoProgramDashboardPage() {
  ...
  return (
    <DashboardShell
      title="Expo Program Dashboard"
      description="Monitor assigned expos, booth inventory, and current publication status."
      breadcrumbs={[
        { label: "Overview", href: "/partner" },
        { label: "Expo Program Dashboard" }
      ]}
    >
      <div className="space-y-6 px-4 py-4">
        ...
        <Card>
          <CardHeader className="gap-2 sm:flex sm:flex-row sm:items-center sm:justify-between">
            <div>
              <CardTitle>Expo List</CardTitle>
              <CardDescription>
                Click an expo to open its operation detail page.
              </CardDescription>
            </div>
            <Button asChild variant="outline" className="rounded-full">
              <Link href="/partner/expo-program/expos">View all programs</Link>
            </Button>
          </CardHeader>
          <CardContent>
