...
- **Downstream — [US-01][CORE] Configure Payment Method**: Bank Transfer cannot be activated if no primary account exists
- **Downstream — [US-05][CORE] QR Bank Transfer Payment**: reads the primary account to generate VietQR
