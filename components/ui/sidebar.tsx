...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute after:absolute after:inset-s-1/2 after:inset-y-0 after:w-[2px] ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 hidden hover:after:bg-sidebar-border inset-y-0 ltr:-translate-x-1/2 rtl:-translate-x-1/2 sm:flex transition-all w-4 z-20",
