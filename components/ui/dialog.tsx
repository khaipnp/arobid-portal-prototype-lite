...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-8 -mb-8 flex flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/50 px-4 py-4 sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    >
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn("font-bold font-heading text-lg leading-none", className)}
      {...props}
    />
  );
}
