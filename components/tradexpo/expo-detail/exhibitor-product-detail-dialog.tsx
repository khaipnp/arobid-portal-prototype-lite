...
export function ExhibitorProductDetailDialog({
  ...
  return (
    ...
    >
      <DialogContent
        showCloseButton
        className="max-w-screen! rounded-2xl max-h-screen px-4 md:px-16 rounded-none"
      >
        {selectedProduct ? (
          <div className="grid gap-5 lg:grid-cols-[1fr_440px]">
            <ScrollArea className="h-screen">
              <DialogHeader className="space-y-2">
                ...
                <DialogTitle className="pr-8 text-lg leading-7 sm:text-xl">
              ...
              <div className="grid gap-3 md:grid-cols-[88px_1fr]">
                ...
                <div className="order-1 relative aspect-[16/10] overflow-hidden rounded-2xl border border-muted md:order-2">
                  <Image
