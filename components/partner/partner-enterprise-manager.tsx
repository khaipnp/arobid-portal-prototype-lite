      ...
      >
        <DialogContent className="sm:max-w-xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Add companies to this partner account.
            </DialogDescription>
          </DialogHeader>
            ...
            {formMode === "add" ? (
              <div className="space-y-3 rounded-lg border p-3">
                <div className="grid gap-2">
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      placeholder="Name, tax ID, website"
                    />
                    <Button
                      type="button"
                      variant="outline"
                ...
                <div className="rounded-md bg-muted p-2 text-muted-foreground text-sm">
                  {selectedCompanyIds.length} selected. Select none to create a
                  share link.
                </div>
                {inviteUrl ? (
              ...
              {isSaving
                ...
                : formMode === "add"
                  ? selectedCompanyIds.length > 0
                    ? `Invite ${selectedCompanyIds.length}`
                    : "Create link"
                  : "Save"}
            </Button>
          </DialogFooter>
